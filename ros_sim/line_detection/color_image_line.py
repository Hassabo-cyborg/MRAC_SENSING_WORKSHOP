...
def get_color_range():
    lower_range = (0, 100, 100)  # Adjust these values based on your specific color range
    upper_range = (10, 255, 255)  # Adjust these values based on your specific color range
